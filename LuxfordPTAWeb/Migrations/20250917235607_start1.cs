    ...
    public partial class start1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventCats", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReflectionsTheme = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DragonName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DragonPersona = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SponsorLevel", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventCatSubs", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventCatSubId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_EventCatSubs_EventCatSubId",
                        column: x => x.EventCatSubId,
                        principalTable: "EventCatSubs",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Events_EventCats_EventCatId",
            ...
            migrationBuilder.CreateTable(
                name: "SponsorAssignments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SponsorId = table.Column<int>(type: "int", nullable: false),
                    SponsorLevelId = table.Column<int>(type: "int", nullable: false),
                    SchoolYearId = table.Column<int>(type: "int", nullable: false),
                    EventId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SponsorAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SponsorAssignments_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SponsorAssignments_SchoolYears_SchoolYearId",
                        column: x => x.SchoolYearId,
                        principalTable: "SchoolYears",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SponsorAssignments_SponsorLevel_SponsorLevelId",
                        column: x => x.SponsorLevelId,
                        principalTable: "SponsorLevel",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SponsorAssignments_Sponsors_SponsorId",
                        column: x => x.SponsorId,
                        principalTable: "Sponsors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_EventCatId",
                table: "Events",
                column: "EventCatId");

            migrationBuilder.CreateIndex(
                name: "IX_Events_EventCatSubId",
                table: "Events",
                column: "EventCatSubId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SponsorAssignments_EventId",
                table: "SponsorAssignments",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_SponsorAssignments_SchoolYearId",
                table: "SponsorAssignments",
                column: "SchoolYearId");

            migrationBuilder.CreateIndex(
                name: "IX_SponsorAssignments_SponsorId",
                table: "SponsorAssignments",
                column: "SponsorId");

            migrationBuilder.CreateIndex(
                name: "IX_SponsorAssignments_SponsorLevelId",
                table: "SponsorAssignments",
                column: "SponsorLevelId");
        }
