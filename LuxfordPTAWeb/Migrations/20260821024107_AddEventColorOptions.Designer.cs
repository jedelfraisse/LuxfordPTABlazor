...
namespace LuxfordPTAWeb.Migrations
{
    ...
    [Migration("20260821024107_AddEventColorOptions")]
    partial class AddEventColorOptions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LuxfordPTAWeb.Shared.Models.BugReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LuxfordPTAWeb.Shared.Models.Event", b =>
                {
                    ...
                    b.Property<string>("FlyerUrlsJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("MoreDetailsHtml")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MoreDetailsMarkdown")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime?>("SignupWindowEnd")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("SignupWindowStart")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("LuxfordPTAWeb.Shared.Models.EventCat", b =>
                {
                    ...
                    b.Property<int>("CoordinatorRequirement")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("EditingPermission")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LuxfordPTAWeb.Shared.Models.EventColorOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LuxfordPTAWeb.Shared.Models.EventControl", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("PublicInformation")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("EventId", "IsDirector")
                        .IsUnique()
                        .HasFilter("[IsDirector] = 1");

                    b.HasIndex("EventId", "SequenceOrder");

                    b.ToTable("EventControls");
                });
            ...
            modelBuilder.Entity("LuxfordPTAWeb.Shared.Models.EventDay", b =>
                {
                    ...
                    b.Property<bool>("PublicVisibleFromTryOuts")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LuxfordPTAWeb.Shared.Models.EventTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DefaultDescriptionMarkdown")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("DefaultMoreDetailsMarkdown")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("IsActive", "EventCatId");

                    b.ToTable("EventTemplates");
                });

            modelBuilder.Entity("LuxfordPTAWeb.Shared.Models.LoginCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LuxfordPTAWeb.Shared.Models.TalentShowAct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MusicStartOffsetSeconds")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PerformerNotes")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PropsRequired")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("SelectedForShow")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("TalentShowActs");
                });

            modelBuilder.Entity("LuxfordPTAWeb.Shared.Models.TalentShowDisplayAssignmentHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EventId", "AssignedAt");

                    b.ToTable("TalentShowDisplayAssignmentHistories");
                });

            modelBuilder.Entity("LuxfordPTAWeb.Shared.Models.TalentShowSessionState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("EstimatedSegmentMinutes")
                        .HasColumnType("int");

                    b.Property<int>("EventId")
                        .HasColumnType("int");

                    b.Property<string>("HostScriptPointer")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("IntermissionEndTime")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("LiveSubState")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("NextLiveSubState")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<DateTime>("SegmentStartedAtUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("TalentShowSessionStates");
                });

            modelBuilder.Entity("LuxfordPTAWeb.Shared.Models.TalentShowSignup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("TryOutSession")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LuxfordPTAWeb.Shared.Models.TalentShowTryOutEntry", b =>
                {
                    ...
                    b.Property<string>("JudgeCompletionsJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LuxfordPTAWeb.Shared.Models.TalentShowVote", b =>
                {
                    ...
                    b.Property<int>("CrowdEngagementScore")
                        .HasColumnType("int");

                    b.Property<string>("DeviceOrUserId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("StagePresenceScore")
                        .HasColumnType("int");

                    b.Property<int>("TalentScore")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LuxfordPTAWeb.Shared.Models.TalentShowDisplayAssignmentHistory", b =>
                {
                    b.HasOne("LuxfordPTAWeb.Shared.Models.Event", "Event")
                        .WithMany("TalentShowDisplayAssignments")
                        .HasForeignKey("EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LuxfordPTAWeb.Shared.Models.TalentShowSessionState", b =>
                {
                    b.HasOne("LuxfordPTAWeb.Shared.Models.Event", "Event")
                        .WithOne("TalentShowSessionState")
                        .HasForeignKey("LuxfordPTAWeb.Shared.Models.TalentShowSessionState", "EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LuxfordPTAWeb.Shared.Models.Event", b =>
                {
                    ...
                    b.Navigation("TalentShowActs");

                    b.Navigation("TalentShowDisplayAssignments");
